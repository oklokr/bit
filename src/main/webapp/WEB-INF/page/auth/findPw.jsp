    ...
    <div class="content">
        <div class="find-wrap">
            ...
            <div class="input-item">
                ...
                <input type="text" class="form-control" id="id" placeholder="아이디를 입력해주세요." maxlength="15" autofocus>
        ...
        <div class="result-wrap" style="display: none;">
            <h2 class="page-title">신규 비밀번호 발급</h2>
...
<script>
    function handleFindId() {
        ...
        postRequestApi("/api/auth/findPw", postData, res => {
            ...
            document.querySelector(".result-txt > strong").innerHTML = id
        });
    }
